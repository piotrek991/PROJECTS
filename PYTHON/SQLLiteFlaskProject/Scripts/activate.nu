...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Projekty\Projekty_python\SQLLiteFlaskProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Projekty\Projekty_python\SQLLiteFlaskProject\Scripts\deactivate.nu'
